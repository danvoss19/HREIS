...
$stmt = $conn->prepare("SELECT firstname, email, lastname, designation, department, salary_grade, joining_date, avatar 
                        FROM employees 
                        WHERE id = ?");
...
<head>
  ...
  <title>HR Employee Information System | Dashboard</title>
  <style>
    :root {
      --primary: #7152F3;
      --primary-dark: #5b3fd6;
...
<body>
  ...
  <div class="main">
    ...
    <div class="section">
      <div class="section-title">
        <i class="fas fa-id-badge"></i> Profile Snapshot
      </div>
      <div class="info-grid">
        <div class="info-item">
        ...
        <div class="info-item">
          ...
          <span><?php echo date("F d, Y", strtotime($employee['joining_date'])); ?></span>
        </div>
        <div class="info-item">
    ...
    <div class="grid" style="margin-top: 25px;">
      <div class="form-box">
        <h4><i class="fas fa-file-contract"></i> Leave Form</h4>
        <p>Submit and track your leave requests with our streamlined form. Record reasons, dates, and duration for accurate documentation and approval.</p>
        <button onclick="downloadLeaveForm()">
          <i class="fas fa-download"></i> Download Form
        </button>
      </div>
      <div class="form-box">
        <h4><i class="fas fa-user-edit"></i> Personal Data Sheet</h4>
        <p>Update your personal, educational, and employment information. This comprehensive form supports job applications and personnel management.</p>
        <button onclick="downloadPDSForm()">
          <i class="fas fa-download"></i> Download Form
        </button>
      </div>
    </div>
  ...
  <script>
    function downloadLeaveForm() {
      ...
      // Download the personalized leave form
      window.location.href = 'download_leave_form_html.php';
    ...
    function downloadPDSForm() {
      window.location.href = "pds-form.pdf";
    }

    function downloadPDSForm() {
      /* alert("Personal Data Sheet download initiated."); */
      window.location.href = "pds-form.pdf";
    }
